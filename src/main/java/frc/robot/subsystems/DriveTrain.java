...
public class DriveTrain extends SubsystemBase {
  ...
  public void periodic() {
    ...
    if (DriveConstants.kHasDriveTrain && DriveConstants.kHasGyro) {
      double reverse = backwards? -1 : 1;
      m_odometry.update(Rotation2d.fromDegrees(getHeading()), 
        reverse*m_leftEncoder.getPosition(), reverse * -m_rightEncoder.getPosition());
      //System.out.println("Odo: "+m_odometry.getPoseMeters().toString());
    }
    if (DriveConstants.kHasPixy) {
