...
public class OldDriveTrain extends SubsystemBase {
   ...
   */
  public OldDriveTrain(OldRobotType robot) {
    switch (robot){
      case Jeff: {
  ...
  public void aperiodic() {
    ...
    */
    ...
    if(mode) {
      ...
      setPoint = 0;//-RobotContainer.driverJoystick.getRawAxis(1)*maxRPM;
      double xSpeed = 0;//-RobotContainer.driverJoystick.getRawAxis(1);
      double zRotation = 0;//RobotContainer.driverJoystick.getRawAxis(4);
      boolean isQuickTurn = false;//RobotContainer.driverJoystick.getRawButton(6);
      ...
      setPoint = 0;//5*RobotContainer.driverJoystick.getRawAxis(1);
